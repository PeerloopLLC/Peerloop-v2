          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{
                ...
                Use this AI prompt to help design your course structure, learning objectives, and pricing.
                Give it to Claude or ChatGPT to guide you through the planning process.
              </div>
            </div>
            <button
              onClick={() => {
                const templateContent = `# PeerLoop Course Creation Assistant
...
`;
                ...
                a.href = url;
                a.download = 'peerloop-course-planning-template.md';
            ...
            >
              <span style={{ fontSize: 16 }}>⬇</span> Download Template
            </button>
          </div>
        </div>
      </div>
  ...
  // Full-page preview mode - uses the real CourseDetailView
  if (previewCourse) {
    return (
      <div style={{
        ...
        {/* Preview Header with Breadcrumb */}
        <div style={{
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'space-between',
          ...
          <div style={{
            ...
            <span>Content</span>
            <span style={{ opacity: 0.5 }}>›</span>
            <span style={{ color: textPrimary, fontWeight: 500 }}>{previewCourse.title}</span>
          </div>
        ...
        {/* Real CourseDetailView Preview */}
        <div style={{ height: 'calc(100vh - 56px)', overflow: 'auto' }}>
          <CourseDetailView
            course={previewCourse}
            onBack={() => { setPreviewCourse(null); setPreviewTab('card'); }}
            isDarkMode={isDarkMode}
  ...
  return (
    <div style={{
      ...
      {/* Old preview modal removed - now using full-page preview */}
      {false && (
        <div
          style={{
            position: 'fixed',
