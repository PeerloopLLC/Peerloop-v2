...
/**
 * RescheduleOptionsModal - Shows reschedule options when user clicks Reschedule
 * Options (no "Get Instant Access" since course is already purchased):
 * 1. Choose Your Teacher - Browse certified student teachers
 * 2. Choose Your Schedule - Choose date, then see available teachers
 */
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h3 style={{
            ...
            How do you want to reschedule {course?.title || 'this session'}?
          </h3>
        </div>
